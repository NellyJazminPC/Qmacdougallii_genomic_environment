...
do python ~/proj/fastStructure/structure.py -K $i --input=variants.fil.79.fil4 --output=variants.fil.79.fil4.simple --full --seed=200 ;
done
 
python ~/proj/fastStructure/chooseK.py --input=variants.fil.79.fil4.simple > chooseK.variants.fil.79.fil4.simple.txt

cat chooseK.variants.fil.79.fil4.simple.txt
