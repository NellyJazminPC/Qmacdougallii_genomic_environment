# "Analysis of functional genomic variation and its association with environmental variables in *Quercus macdougallii* Martínez (Fagaceae), an oak endemic to Oaxaca"

Preliminary project for admission to the Ph. D. in Biological Sciences in the area of Ecology of the National Autonomous University of Mexico (UNAM).
...
Are important **reservoirs of biomass and biodiversity**, in addition to **providing ecological services** and being an indisputable part of the **biocultural heritage** of humankind [(Gil-Pelegrín *et al.,* 2017)](https://link.springer.com/book/10.1007%2F978-3-319-69099-5).
...
<p align="center">
<img src="sdgs.png" width="350"/>

</p>

## Schedule of activities

| 2021-1 to 2024-2                                             | 1         | 2         | 3         | 4         | 5         | 6         | 7         | 8         |
| :----------------------------------------------------------- | :-------- | --------- | --------- | --------- | --------- | --------- | --------- | --------- |
| Literature review                                            | ~~**X**~~ | ~~**X**~~ | ~~**X**~~ | ~~**X**~~ | ~~**X**~~ | ~~**X**~~ | ~~**X**~~ | ~~**X**~~ |
| Writing the theoretical framework and background of the project | ~~**X**~~ | ~~**X**~~ | ~~**X**~~ |           |           |           |           |           |
| Field work                                                   | ~~**X**~~ | ~~**X**~~ | ~~**X**~~ | ~~**X**~~ | ~~**X**~~ | ~~**X**~~ |           |           |
| Lab work                                                     | ~~**X**~~ | ~~**X**~~ | ~~**X**~~ | ~~**X**~~ | ~~**X**~~ | ~~**X**~~ |           |           |
| Bioinformatic and statistical analysis                       | ~~**X**~~ | ~~**X**~~ | ~~**X**~~ | ~~**X**~~ | ~~**X**~~ | ~~**X**~~ | ~~**X**~~ | ~~**X**~~ |
| Writing and sending the first article                        |           | ~~**X**~~ | ~~**X**~~ |           |           |           |           |           |
| Thesis writing                                               | ~~**X**~~ | ~~**X**~~ | ~~**X**~~ | ~~**X**~~ | ~~**X**~~ | ~~**X**~~ | ~~**X**~~ | ~~**X**~~ |
| PhD Candidacy Exam                                           |           |           |           | ~~**X**~~ |           |           |           |           |



![img](https://lh6.googleusercontent.com/h4qFoNbqhb7VaLFd5mKkZnwUXrDlSStZycx1kDyKAuRpWLZFtBSve2VNj8rEDxNG-O2xbpQe9HdJlngL2Hc_ZiInnHET06PQlINlwaYSDpyg7ES_lOnfNorOnxOC1WzvK5bifXs)